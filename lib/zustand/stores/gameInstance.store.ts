...
import {
    EncryptedQuoteType,
    GameQuoteFieldCharacterType,
    GameQuoteFieldWordType,
} from "@/types/game";
...
export const useGameInstanceStore = create<
    GameInstanceStoreState & GameInstanceStoreActions
>((set) => ({
    ...defaultGameInstance,
    init: (game, options) => {
        ...
        let inputs = {};
        inputs = Object.keys(reversedMap).reduce(
